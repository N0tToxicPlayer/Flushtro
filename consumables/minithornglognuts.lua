SMODS.Consumable {
    ...
    loc_txt = {
        name = 'Mini Thorn Glognuts',
        text = {
        [1] = 'levels up a random poker hand by {C:attention}2{} levels',
        [2] = 'comes with an {C:tarot}epic{} joker included',
        ...
        local used_card = copier or card
            ...
            G.E_MANAGER:add_event(Event({
                  ...
                  func = function()
                      ...
                      local new_joker = SMODS.add_card({ set = 'Joker', rarity = 'flush_epic' })
                      if new_joker then
                      end
